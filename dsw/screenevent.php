        ...
        <div class="wrapper">
            ...
            <div style=" height: auto; width: 600px; margin: auto; left: 0; right: 0; top: 40px; bottom: 0px;">
                ...
                <div style="border: 1px solid #b2b0b0; box-shadow: 0 0 10px darkgrey; padding: 10px; height: auto; width: 600px; text-align:center;">
                    ...
                    <div style="float: left; margin-bottom:20px; border: 1px solid darkgrey; width: 400px; height: 238px; overflow-y: scroll; padding: 5px; ">
                        <p><?php echo $desc; ?></p>
                ...
                <input type="submit" name="verify" value="No" id="delBtn" style= "margin-bottom:80px;">
