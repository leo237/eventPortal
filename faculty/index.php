 ...
 if(!empty($_REQUEST['mode']))
    {
                 ...
                 // $pass = md5($tempPass);   
                    $sqlQuery = "SELECT * FROM faculty WHERE emailID = '$user' AND password = '$tempPass' ";
        ...
        <div class="wrapper">
            ...
            <div id="container">
                ...
                <div id="right" style="position: relative; top: -25px; display: inline-block;">
                    <h4 style="position: relative; bottom: 5px;"><strong></strong> Welcome!</h4>
                    
                    
                    <form method = "POST">
                        <input type="hidden" name="mode" value="1" />
                        <label>Email ID:</label><input type="text" style="width: 150px;" name="id" required autofocus="true"><br>
